...
public class Weather {
	public static void main(String[] args) {
		// This program will give a suggestions of what to wear based on the weather (temperature)
		...
		if (temperature > 80) {
			...
			System.out.println("It's a cold day, make sure to wear warmer clothes.");
		}
